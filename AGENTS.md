...
|---|---|---|---|
| Externally distributed skills | `skills/<name>/` | `npx skills add https://github.com/jason-xie-123/yueban-skills.git` | `yueban-doc-authority-audit`, `yueban-doc-md-title-export`, `yueban-docs-format-conversion`, `yueban-docs-freshness-audit`, `yueban-proj-prune-historical`, `yueban-english-speaking-practice`, `yueban-git-commit`, `yueban-git-feature-branch-flow`, `yueban-git-safe-sync`, `yueban-spec-loop`, `yueban-spec-roadmap-flow`, `yueban-spec-single-change-flow` |
